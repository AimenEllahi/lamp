...
export function LampNew(props) {
  const { nodes, materials, scene } = useGLTF(
    "/Models/LampNew-transformed.glb"
  );
  const texture = useTexture("/tv.jpg");

  const glowingPic = new THREE.ShaderMaterial({
    uniforms: {
      glowColor: { type: "c", value: new THREE.Color(0xf00fff) },
      globTexture: {
        type: "t",
        value: new THREE.TextureLoader().load("/tv.jpg"),
      },
    },
    vertexShader: `   
  varying vec3 vNormal;
  ...
  return (
    ...
    >
      ...
      <pointLight
        ...
        rotation={rotation}
      />
      {/* {ref.current && <pointLightHelper args={[ref.current]} />} */}
